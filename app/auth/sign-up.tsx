        ...
        <ThemedView style={styles.content}>
          ...
          <ThemedView style={styles.terms}>
            <AppCheckBox
              ...
              onValueChange={(checked) => setAgreedToTerms(checked)}
            />
            <ThemedText style={styles.check}>
              I have agreed with{" "}
              <Link href="/legal/terms-conditions" style={styles.link}>
                Terms & Conditions.
              </Link>
            </ThemedText>
          </ThemedView>
        </ThemedView>
        <ThemedText style={styles.alreadyHaveAnAccount} type="defaultMedium">
